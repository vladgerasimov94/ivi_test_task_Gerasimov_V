...
*/
    ...
    public void testRaitingInSearchAndGooglePlay() {
        ...
        searchAndGoGooglePlayLinksOnPages(); // !ѕроверка внутри цикла! ÷икл по поиску ссылок на страницах 1:5 и переход в GooglePlay + сравнение рейтинга. ѕодробности в TestBase
    }
